...
public class Service_subway_safety_info_en implements  Interface_Traffic_main_Service  {
	private SqlSession sqlSession;

	public Service_subway_safety_info_en(SqlSession sqlSession) {
...
//		model.addAttribute("ssafetyL",ssafetyL);
    ...
    private static String post(String apiUrl, Map<String, String> requestHeaders, String textToTranslate){
        ...
        String postParams = "source=ko&target=en&text=" + textToTranslate; //원본언어: 한국어 (ko) -> 목적언어: 영어 (en)
        try {
